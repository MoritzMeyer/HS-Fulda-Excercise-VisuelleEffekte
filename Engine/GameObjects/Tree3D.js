...
class Tree3D extends RenderObject
{
    constructor()
    {
        let color1 = new Color("uObjectColor", Shader.getDefaultColorShader(false), [0.8, 0.0, 0.0]);
        let color2 = new Color("uObjectColor", Shader.getDefaultColorShader(false), [0.0, 0.8, 0.0]);
        let color3 = new Color("uObjectColor", Shader.getDefaultColorShader(false), [0.0, 0.0, 0.8]);
        let color4 = new Color("uObjectColor", Shader.getDefaultColorShader(false), [0.8, 0.8, 0.0]);
