...
class Tree3D extends RenderObject
{
    constructor()
    {
        let color1 = new Color("uColor", Shader.getDefaultShader(), [0.8, 0.0, 0.0, 1.0]);
        let color2 = new Color("uColor", Shader.getDefaultShader(), [0.0, 0.8, 0.0, 1.0]);
        let color3 = new Color("uColor", Shader.getDefaultShader(), [0.0, 0.0, 0.8, 1.0]);
        let color4 = new Color("uColor", Shader.getDefaultShader(), [0.8, 0.8, 0.0, 1.0]);
